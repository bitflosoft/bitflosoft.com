...
const SOCIALS = [
  {
    label: "X / Twitter",
    href: "https://twitter.com/bitflosoft",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/bitflosoft",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "GitHub",
    href: "https://github.com/bitflosoft",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className="border-t border-zinc-200 dark:border-white/[0.06] py-10 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-2.5">
          <img src="/logo.svg" alt="Bitflosoft" className="w-6 h-8 object-contain" />
        </div>
